...
export function InventoryView() {
  ...
  const dataFiltered: InventoryItem[] = applyFilter({
    inputData: inventory,
  ...
  return (
    <DashboardContent>
      <FormDialog openFormModal={openFormModal} setOpenFormModal={setOpenFormModal} action="add" />
          ...
          <TableContainer sx={{ overflow: 'unset' }}>
            <Table sx={{ minWidth: 800 }}>
              <UserTableHead
                ...
                onSelectAllRows={(checked) =>
                  table.onSelectAllRows(
                    checked,
                    inventory.map((row) => row.id.toString())
                  )
                }
                headLabel={[
                  { id: 'item', label: 'Name' },
              ...
              <TableBody>
                ...
                <TableEmptyRows
                  height={68}
                  emptyRows={emptyRows(table.page, table.rowsPerPage, inventory.length)}
                />
